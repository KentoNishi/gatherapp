			...
			try{
				...
				if(member!=null){
					...
					contents.push({html:cb+append+" <span class='okbutton' class='class"+id+"' onclick='document.querySelectorAll("+'".okbutton"'+
						       ...
						       ")[0].innerHTML=null;saveReminderTime(document.querySelectorAll("+'".class'+id+'"'+
						       ")[0].classList[0]);'></span> <span class='nobutton' class='class"+id+"' onclick='document.querySelectorAll("+
